...
sample_event_stream_data = [
    ...
    {'type': 'gameFinish', 'game': {'fullId': 'SV0lgdphuXLO', 'gameId': 'SV0lgdph', 'fen': '5rk1/p2n1ppp/b3pn2/2p5/7N/6P1/1q1NPPBP/1R1Q1RK1 b - - 1 15', 'color': 'white', 'lastMove': 'c1b1', 'source': 'friend', 'variant': {'key': 'standard', 'name': 'Standard'}, 'speed': 'bullet', 'perf': 'bullet', 'rated': False, 'hasMoved': True, 'opponent': {'id': 'hgducharme', 'username': 'hgducharme', 'rating': 867}, 'isMyTurn': False, 'secondsLeft': 20, 'compat': {'bot': True, 'board': False}, 'id': 'SV0lgdph'}},
    {'type': 'challenge', 'challenge': {'id': 'FVDv868k', 'url': 'https://lichess.org/FVDv868k', 'status': 'created', 'challenger': {'id': 'stockai', 'name': 'stockAI', 'title': 'BOT', 'rating': 2000, 'provisional': True, 'online': True}, 'destUser': {'id': 'hgducharme', 'name': 'hgducharme', 'title': None, 'rating': 880}, 'variant': {'key': 'standard', 'name': 'Standard', 'short': 'Std'}, 'rated': False, 'speed': 'bullet', 'timeControl': {'type': 'clock', 'limit': 60, 'increment': 0, 'show': '1+0'}, 'color': 'random', 'finalColor': 'white', 'perf': {'icon': '\ue047', 'name': 'Bullet'}}, 'compat': {'bot': True, 'board': False}},
...
# TODO: Turn fake_event_stream into an byte-like iterable object
fake_event_stream = iter(sample_event_stream_data)